# encoding: utf-8
# module PySide.QtSvg
# from /corp.blizzard.net/BFD/Deploy/Packages/Published/ThirdParty/Qt4.8.4/2015-05-15.163857/prebuilt/linux_x64_gcc41_python2.7_ucs4/PySide/QtSvg.so
# by generator 1.138
# no doc
...
class QGraphicsSvgItem(__PySide_QtGui.QGraphicsObject):
    # no doc
...
class QSvgGenerator(__PySide_QtGui.QPaintDevice):
    # no doc
...
class QSvgRenderer(__PySide_QtCore.QObject):
    # no doc
...
class QSvgWidget(__PySide_QtGui.QWidget):
    # no doc
    def load(self, *args, **kwargs): # real signature unknown
        pass
